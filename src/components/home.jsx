...
var Banner = require('babel!./banner.jsx');
var Content = require('babel!./content.jsx');
...
var Home = React.createClass({
  ...
  render() {
    ...
    var test = [
      ...
      ["p", "The plastic road material, according to VolkerWessels, would require less maintenance and last three times longer than conventional asphalt. And it would also be able to withstand more extreme temperatures, between -40 to 176 degrees Farenheit (-40 to 80 degrees Celsius)."],
